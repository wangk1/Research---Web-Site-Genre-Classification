...
__default_handler=DefaultExceptionHandler()
__encoding_handler=EncodingHandler()
...
def fail_safe_encode(func):
    return fail_safe_with_handler(__encoding_handler)(func)
